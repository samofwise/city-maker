/**
 * Memoised per-cell rendering. Each CellPolygon only re-renders when one of its
 * own vertex positions changes, making vertex drag O(adjacent-cells) instead of
 * O(all-cells).
 */
